...
<div class="container-fluid">
    <div class="row page-titles">
        <div class="col-md-6 col-8 align-self-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ url('/package') }}">ตารางแพ็คเกจ</a></li>
            </ol>
        </div>
    </div>
    <div class="row">
            ...
            <form id="FormAdd">
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label for="add_description">คำอธิบาย</label>
                                <textarea class="form-control" name="description" id="add_description" rows="10"></textarea>
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="form-group">
...
<script>
    ...
    $('body').on('click', '.btn-edit', function (e) {
        ...
        $.ajax({
            method: "GET",
            url: url_gb + "/package/get/get_by_id/" + id,
            dataType: 'json'
        }).done(function (rec) {
